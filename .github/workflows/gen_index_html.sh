...
for d in $SORTED; do
  ...
  echo "    <td> <table style="background-color:rgba(0, 0, 0, 0);"> <tr> <td>rfc7950bis</td> <td><a href=\"$d/draft-yn-netmod-rfc7950bis-00.html\">html</a> / <a href=\"$d/draft-yn-netmod-rfc7950bis-00.txt\">text</a> / <a href=\"$d/draft-yn-netmod-rfc7950bis-00.xml\">xml</a></td> </tr> <tr> <td>yang-xml</td> <td><a href=\"$d/draft-yn-netmod-yang-xml-00.html\">html</a> / <a href=\"$d/draft-yn-netmod-yang-xml-00.txt\">text</a> / <a href=\"$d/draft-yn-netmod-yang-xml-00.xml\">xml</a></td> </tr> <tr> <td>yang-proto</td> <td><a href=\"$d/draft-yn-netmod-yang-proto-00.html\">html</a> / <a href=\"$d/draft-yn-netmod-yang-proto-00.txt\">text</a> / <a href=\"$d/draft-yn-netmod-yang-proto-00.proto\">proto</a></td> </tr> </table> </td>" >> index.html

  if [ $d = "main" ]; then
    echo "    <td><table style="background-color:rgba(0, 0, 0, 0);"> <tr> <td>rfc7950bis</td> <td><a href=\"https://author-tools.ietf.org/diff?doc_1=rfc7950&url_2=https://netmod-wg.github.io/rfc7950bis/main/draft-yn-netmod-rfc7950bis-00.txt\">Diff with RFC7950</a><br><a href=\"https://author-tools.ietf.org/api/iddiff?doc_1=draft-yn-netmod-rfc7950bis&url_2=https://netmod-wg.github.io/rfc7950bis/main/draft-yn-netmod-rfc7950bis-00.txt\">Diff with Datatracker</a><br>Upload to Datatracker (TBD)</td>  </tr> <tr><td>yang-xml</td><td>???</td></tr> <tr><td>yang-proto</td><td>???</td></tr></table> </td>" >> index.html
  else
    echo "    <td> <table style="background-color:rgba(0, 0, 0, 0);"> <tr> <td>rfc7950bis</td> <td><a href=\"https://author-tools.ietf.org/api/iddiff?url_1=https://netmod-wg.github.io/rfc7950bis/main/draft-yn-netmod-rfc7950bis-00.txt&url_2=https://netmod-wg.github.io/rfc7950bis/$d/draft-yn-netmod-rfc7950bis-00.txt\">Diff with Main</a></td> </tr> <tr> <td>yang-xml</td> <td>???</td> </tr> <tr> <td>yang-proto</td> <td>???</td> </tr> </table> </td>" >> index.html
  fi
  echo "  </tr>" >> index.html
done
echo "</table>" >> index.html
