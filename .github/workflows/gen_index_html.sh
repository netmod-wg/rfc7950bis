...
for d in $SORTED; do
  ...
  if [ $d = "main" ]; then
    ...
    echo "    <td><a href=\"https://author-tools.ietf.org/api/iddiff?url_1=https://netmod-wg.github.io/rfc7950bis/main/draft-yn-netmod-rfc7950bis-00.txt&url_2=https://netmod-wg.github.io/rfc7950bis/$d/draft-yn-netmod-rfc7950bis-00.txt\">Diff with Main</a></td>" >> index.html
  fi
  echo "  </tr>" >> index.html
done
echo "</table>" >> index.html
